...
La estrategia vigente se divide en dos etapas:
- Etapa 1: calibracion/verificacion exclusiva de instrumentos topograficos y ruta a acreditacion INN geodimensional.
- Etapa 2: expansion posterior a balanzas, masas patron, temperatura, humedad, presion y dimensional general.

## MVP actual
- Resumen ejecutivo del estudio de mercado.
- KPIs de oportunidad, inversion, plazo e ingresos potenciales por etapa.
...
- No usar la ruta SAG/Ley 20.656 para topografia; aplica a Etapa 2 cuando exista servicio para transacciones agropecuarias reguladas.
