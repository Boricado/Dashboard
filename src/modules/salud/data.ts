...
export const workoutRoutines: WorkoutWeek[] = [
  ...
  },
  {
    ...
    label: "Semana 21",
    focus: "Carga fuerte",
    statusLabel: "Segunda construccion",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push B", status: "upcoming" },
      ...
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "16 km Z2" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    label: "Semana 22",
    focus: "Descarga",
    statusLabel: "Descarga post 3 semanas",
    days: [
      ...
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "11 km Z2" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      ...
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "17 km Z2" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push A", status: "upcoming" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "10 km Z2" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull B", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "18-19 km Z2" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    label: "Semana 25",
    focus: "Descarga",
    statusLabel: "Descarga post pico",
    days: [
      ...
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "12 km Z2" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    id: "s26",
    label: "Semana 26",
    focus: "Taper — reducir volumen",
    statusLabel: "Taper",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push A", status: "upcoming", note: "taper — 3×8-10, -15% peso" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "5 km Z2 suave" },
      ...
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "10 km Z2 — ultimo contacto" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    id: "s27",
    label: "Semana 27",
    focus: "Taper final — descargar",
    statusLabel: "Taper final",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push B", status: "upcoming", note: "taper — 3×8, -20% peso" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "4 km Z2 muy suave" },
      ...
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "8 km Z2 muy suave" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      ...
      { dayShort: "Sab", dayName: "Sabado", session: "Activacion", status: "upcoming", note: "20 min suave + 3 strides" },
      { dayShort: "Dom", dayName: "Domingo", session: "Media Maraton", status: "upcoming", note: "21.1 km — objetivo sub-2h (5:41/km)" },
    ],
  },
];
