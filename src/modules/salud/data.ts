...
export const inbodyScans: InBodyScan[] = [
  ...
  },
  {
    ...
    mineralsKg: 4.54,
    bodyFatMassKg: 24.5,
    skeletalMuscleKg: 39.2,
    bodyFatPercent: 26.4,
    bmi: 30.3,
    score: 78,
    targetWeightKg: 80.4,
    weightControlKg: -12.4,
    fatControlKg: -12.4,
    muscleControlKg: 0,
    waistHipRatio: 0.97,
    visceralFatLevel: 11,
    obesityDegree: 138,
    basalMetabolicRateKcal: 1846,
    fatFreeMassKg: 68.3,
    imeKgM2: 0,
    segmentalLean: {
      leftArm: { kg: 4.25, percent: 127.5 },
      rightArm: { kg: 4.25, percent: 127.9 },
      trunk: { kg: 31.5, percent: 113.9 },
      leftLeg: { kg: 9.75, percent: 96.8 },
      rightLeg: { kg: 9.75, percent: 95.8 },
    },
    segmentalFat: {
      leftArm: { kg: 1.4, percent: 230.0 },
      rightArm: { kg: 1.4, percent: 229.0 },
      trunk: { kg: 14.1, percent: 331.2 },
      leftLeg: { kg: 3.0, percent: 174.6 },
      rightLeg: { kg: 3.0, percent: 174.2 },
    },
    impedance: {
      z20: { bd: 258.0, bi: 262.0, tr: 21.5, pd: 248.0, pi: 243.0 },
      z100: { bd: 226.0, bi: 230.0, tr: 18.0, pd: 216.0, pi: 211.0 },
    },
    fileName: null,
    filePath: null,
    fileMimeType: null,
...
export const workoutRoutines: WorkoutWeek[] = [
  {
    ...
    statusLabel: "Descarga",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push A", status: "completed", note: "deload" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "completed", note: "4 km Z2" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "completed", note: "deload" },
      { dayShort: "Jue", dayName: "Jueves", session: "Cardio Z2", status: "upcoming", note: "30 min" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "today", note: "deload" },
      { dayShort: "Sab", dayName: "Sabado", session: "Carrera", status: "upcoming", note: "8 km moderada" },
  ...
  },
  {
    ...
    days: [
      ...
      { dayShort: "Jue", dayName: "Jueves", session: "Cardio Z2", status: "upcoming", note: "47 min" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "12 km" },
  ...
  },
  {
    ...
    statusLabel: "Carga",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push A", status: "completed", note: "Registrado 04-may" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "7 km Z2" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming", note: "carga completa" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "fatiga acumulada; priorizar recuperacion" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull B", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "completed", note: "13.01 km · 1:27:54 · 6:45/km · FC 152 ppm" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest", note: "recuperacion" },
    ],
  },
  {
  ...
  },
  {
    id: "s18",
    label: "Semana 18",
    focus: "Descarga — viaje",
    statusLabel: "Descarga",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push A", status: "upcoming", note: "descarga -35% — viaje" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "5 km Z3 suave" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming", note: "descarga tecnica — F. ext. rodilla PRIORIDAD" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "recuperacion — viaje" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull B", status: "upcoming", note: "descarga ligera" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "10 km Z3 suave" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    id: "s19",
    label: "Semana 19",
    focus: "Re-entry / Carga suave",
    statusLabel: "RE-ENTRY",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push B", status: "today" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "completed", note: "8 km Z3 \u2714" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "10-11 km Z2" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      ...
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull B", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "14 km Z2" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    label: "Semana 21",
    focus: "Base aeróbica",
    statusLabel: "Construir km — sin ritmo",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push B", status: "upcoming" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "9 km a 7:00-7:30 — muy comodo" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "16 km Z3 — 7:00-7:30, sin forzar" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    label: "Semana 22",
    focus: "Descarga",
    statusLabel: "Descarga — recuperar",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push A", status: "upcoming", note: "descarga" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "6 km a 7:00-7:30 suave" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming", note: "descarga" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull B", status: "upcoming", note: "descarga" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "11 km a 7:00-7:30 — suave" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    label: "Semana 23",
    focus: "Volumen",
    statusLabel: "Construir km",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push B", status: "upcoming" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "9 km a 7:00-7:30" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "17 km a 7:00-7:30" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    statusLabel: "PICO — ultima larga",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push A", status: "upcoming" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "10 km a 7:00-7:30" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull B", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "18-19 km a 7:00-7:30 — el gran dia" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    id: "s25",
    label: "Semana 25",
    focus: "Descarga + ritmo",
    statusLabel: "Descarga — introducir ritmo",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push B", status: "upcoming", note: "descarga" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "6 km Z3 — ultimos 3 km a 6:15-6:30" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming", note: "descarga" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming", note: "descarga" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "12 km — 8 km Z3 + 4 km a 6:15-6:30" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    label: "Semana 26",
    focus: "Taper — soltar",
    statusLabel: "Taper — ultimos detalles",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push A", status: "upcoming", note: "taper — 3×8-10, -15% peso" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "5 km — ult 2 km a 6:00, +4 strides" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming", note: "taper — 3 series, sin fallo" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull B", status: "upcoming", note: "taper — 3×8-10, -15% peso" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "10 km — 7 km Z2 + 3 km a 6:00" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    label: "Semana 27",
    focus: "Taper final",
    statusLabel: "Taper — cargar energia",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push B", status: "upcoming", note: "taper — 3×8, -20% peso" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "4 km Z2 suave + 6 strides" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming", note: "taper — 2-3 series, ligero" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming", note: "taper — 3×8, -20% peso" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "8 km Z2 muy suave — ultimo trote" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    label: "Semana 28",
    focus: "RACE WEEK",
    statusLabel: "RACE DAY — 16 AGO",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Movilidad", status: "upcoming", note: "20-30 min — estiramientos suaves" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "5 km Z2 — muy suave, soltar piernas" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Movilidad", status: "upcoming", note: "sin carga — solo estirar" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "llegar fresco — hidratar bien" },
      { dayShort: "Vie", dayName: "Viernes", session: "Descanso", status: "rest", note: "carb loading — dormir 8h+" },
      { dayShort: "Sab", dayName: "Sabado", session: "Activacion", status: "upcoming", note: "20 min muy suave + 4 strides" },
      { dayShort: "Dom", dayName: "Domingo", session: "Media Maraton", status: "upcoming", note: "21.1 km — salir a 6:30-6:45, apretar solo si sobra" },
    ],
  },
];
...
export const routineTemplates: Record<string, WorkoutExercise[]> = {
  "Push A": [
    { name: "Press de banca plano (barra)", series: "4 x 8-12", load: "57.5 kg / 127 lb" },
    { name: "Press inclinado con mancuernas", series: "3 x 10-12", load: "25 kg / 55 lb c/u" },
    { name: "Press militar con barra", series: "4 x 8-10", load: "35 kg / 77 lb" },
    { name: "Elevaciones laterales", series: "4 x 12-15", load: "10 kg / 22 lb c/u" },
    { name: "Aperturas con mancuernas", series: "3 x 12-15", load: "17.5 kg / 38 lb c/u" },
    { name: "Plancha", series: "3 x 30-45 s", notes: "Core — abdomen profundo" },
    { name: "Russian twists con mancuerna", series: "3 x 12-15 c/u", load: "10 kg / 22 lb" },
    { name: "L-sit", series: "3 x 10-15 s", notes: "En paralelas o suelo — piernas extendidas" },
  ],
  "Push B": [
    { name: "Press inclinado con barra", series: "4 x 8-12", load: "47.5 kg / 105 lb" },
    { name: "Dips en paralelas", series: "3 x 8-12", notes: "BW" },
    { name: "Press de hombro sentado DB", series: "3 x 10-12", load: "17.5 kg / 38 lb c/u" },
    { name: "Elevaciones laterales sentado", series: "4 x 15", load: "10 kg / 22 lb c/u" },
    { name: "Skullcrusher EZ + press cerrado", series: "3 x 10+10", load: "25 lb / 11 kg c/lado" },
    { name: "Plancha", series: "3 x 30-45 s", notes: "Core — abdomen profundo" },
    { name: "Russian twists con mancuerna", series: "3 x 12-15 c/u", load: "10 kg / 22 lb" },
    { name: "L-sit", series: "3 x 10-15 s", notes: "En paralelas o suelo — piernas extendidas" },
  ],
  "Pull A": [
    ...
    { name: "T-bar row", series: "4 x 8-10", load: "45 kg / 100 Lb" },
    { name: "Remo unilateral con mancuerna", series: "3 x 10-12", load: "35 kg / 77 lb c/u" },
    { name: "Face pulls", series: "4 x 15-20", load: "30 kg / 66 lb" },
    { name: "Curl EZ en banco predicador", series: "3 x 10-12", load: "25 kg / 55 lb" },
    { name: "Curl martillo con mancuernas", series: "3 x 10-12", load: "18 kg / 40 lb c/u" },
    { name: "Dead bug", series: "3 x 10-12 c/u", notes: "Core — lumbares y abdomen" },
    { name: "Pallof press (polea)", series: "3 x 12-15 c/u", load: "15 kg / 33 lb", notes: "Core — rotación" },
  ],
  "Pull B": [
    { name: "Jalon al pecho polea agarre ancho", series: "4 x 10-12", load: "45 kg / 100 lb" },
    { name: "Remo con barra agarre prono", series: "4 x 8-10", load: "45 kg / 100 lb" },
    { name: "Pullover con mancuerna", series: "3 x 12-15", load: "24 kg / 53 lb" },
    { name: "Face pulls", series: "4 x 15-20", load: "30 kg / 66 lb" },
    { name: "Curl EZ barra de pie", series: "3 x 10-12", load: "27.5 kg / 60 lb" },
    { name: "Curl inclinado con mancuerna", series: "3 x 12 c/u", load: "12.5 kg / 28 lb c/u" },
    { name: "Dead bug", series: "3 x 10-12 c/u", notes: "Core — lumbares y abdomen" },
    { name: "Pallof press (polea)", series: "3 x 12-15 c/u", load: "15 kg / 33 lb", notes: "Core — rotación" },
  ],
  Pierna: [
    { name: "Goblet squat con mancuerna", series: "4 x 10-12", load: "25 kg / 55 lb", notes: "Max mancuernas gimnasio" },
    { name: "Romanian deadlift con mancuernas", series: "4 x 10-12", load: "25 kg / 55 lb c/u" },
    { name: "Hip thrust con barra", series: "4 x 12-15", load: "55 lb/lado (25 kg) + barra 20 kg" },
    { name: "Curl isquio en maquina", series: "3 x 12-15", notes: "60 lb / 27 kg" },
    { name: "Elevaciones de talon excentricas (escalon)", series: "4 x 15 c/u", notes: "Corporal" },
    { name: "Abductor en maquina", series: "3 x 15-20", notes: "82 lb / 37 kg" },
    { name: "Aductor en maquina", series: "2 x 15-20", notes: "82 lb / 37 kg" },
  ],
  Carrera: [
    { name: "Carrera aerobica Z2", series: "1 bloque", notes: "FC <145, ritmo conversacional" },
  ],
  "Tirada Larga": [
    { name: "Tirada larga Z2", series: "1 bloque", notes: "FC <140-145, ritmo conversacional" },
  ],
  Movilidad: [
...
export const sessionHistory: SessionHistoryItem[] = [
  {
    id: "garmin-2026-05-09-13k",
    date: "09 may",
    week: "S14",
    session: "Tirada Larga",
    summary: "13.01 km · 1:27:54 · 6:45/km · FC media 152 ppm",
    notes:
      "Tirada larga completada. Training effect base aerobica baja, carga 151, alto impacto aerobico 4.4. El jueves se deja como descanso por fatiga para proteger continuidad hacia la media maraton.",
    details: [
      "Distancia: 13.01 km",
      "Tiempo: 1:27:54 · movimiento 1:27:47",
      "Ritmo medio: 6:45/km · GAP 6:47/km · mejor km 5:15/km",
      "Frecuencia cardiaca: 152 ppm media · 169 ppm maxima · Z3 1:15:22 · Z4 11:13",
      "Potencia: 311 W media · 474 W maxima",
      "Cadencia: 159 ppm media · 169 ppm maxima",
      "Desnivel: +31 m / -37 m",
    ],
  },
