...
export const workoutRoutines: WorkoutWeek[] = [
  ...
  },
  {
    ...
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push B", status: "upcoming" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "9 km Z3" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming", note: "carga completa — F. ext. rodilla PRIORIDAD" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "recuperacion preventiva" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "15 km Z3" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
  ...
  },
  {
    ...
    days: [
      ...
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "recuperacion preventiva" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "17 km" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    statusLabel: "Descarga",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push A", status: "upcoming", note: "descarga -35%" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "5 km Z2" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming", note: "descarga tecnica" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "recuperacion preventiva" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull B", status: "upcoming", note: "descarga" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "11 km" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      ...
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "recuperacion preventiva" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "18 km" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      ...
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "recuperacion preventiva" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull B", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "19 km" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    statusLabel: "Descarga",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push B", status: "upcoming", note: "descarga -35%" },
      ...
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "13 km" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      ...
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "recuperacion preventiva" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull B", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "20 km" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      ...
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming", note: "taper activacion" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "recuperacion preventiva" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "15 km" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      ...
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "10 km" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      ...
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "8 km" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      ...
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "llegar fresco a carrera" },
...
export const routineTemplates: Record<string, WorkoutExercise[]> = {
  ...
  Pierna: [
    { name: "Goblet squat con mancuerna", series: "4 x 12", load: "22.5 kg" },
    { name: "Romanian deadlift con mancuernas", series: "4 x 12", load: "22.5 kg c/u" },
    { name: "Hip thrust con barra", series: "4 x 12", load: "60 kg" },
    { name: "Curl de isquio en maquina", series: "3 x 12", load: "25 kg" },
    { name: "Elevaciones de talon excentricas", series: "4 x 15", notes: "Corporal" },
    { name: "Extension terminal de rodilla", series: "3 x 15", notes: "Banda ligera — PRIORIDAD" },
    { name: "Abductor en maquina", series: "3 x 15", load: "80 kg" },
    { name: "Aductor en maquina", series: "3 x 15", load: "80 kg" },
  ],
  "Cardio Z2": [
