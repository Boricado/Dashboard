...
export const workoutRoutines: WorkoutWeek[] = [
  ...
  },
  {
    ...
    statusLabel: "Taper",
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push A", status: "upcoming", note: "taper" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "5 km Z2" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming", note: "taper" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull B", status: "upcoming", note: "taper" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "10 km Z2" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      { dayShort: "Lun", dayName: "Lunes", session: "Push B", status: "upcoming", note: "taper" },
      { dayShort: "Mar", dayName: "Martes", session: "Carrera", status: "upcoming", note: "4 km Z2" },
      { dayShort: "Mie", dayName: "Miercoles", session: "Pierna", status: "upcoming", note: "taper" },
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest" },
      { dayShort: "Vie", dayName: "Viernes", session: "Pull A", status: "upcoming", note: "taper" },
      { dayShort: "Sab", dayName: "Sabado", session: "Tirada Larga", status: "upcoming", note: "8 km Z2" },
      { dayShort: "Dom", dayName: "Domingo", session: "Descanso", status: "rest" },
    ],
  },
  {
    ...
    days: [
      ...
      { dayShort: "Jue", dayName: "Jueves", session: "Descanso", status: "rest", note: "llegar fresco" },
