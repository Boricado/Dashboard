...
export const routineTemplates: Record<string, WorkoutExercise[]> = {
  "Push A": [
    ...
    { name: "Press militar con barra", series: "4 x 8-10", load: "37.5 kg" },
    { name: "Elevaciones laterales", series: "4 x 12-15", load: "11 kg c/u" },
    { name: "Aperturas con mancuernas", series: "3 x 12-15", load: "20 kg c/u" },
  ],
  "Push B": [
    { name: "Press inclinado con barra", series: "4 x 8-12", load: "47.5 kg" },
    { name: "Dips en paralelas", series: "3 x 8-12", notes: "BW+5" },
    { name: "Press de hombro sentado DB", series: "3 x 10-12", load: "20 kg c/u" },
    { name: "Elevaciones laterales sentado", series: "4 x 15", load: "10 kg c/u" },
    { name: "Skullcrusher EZ + press cerrado", series: "3 x 10+10", load: "25 kg" },
  ],
  "Pull A": [
    { name: "Dominadas sin banda", series: "4 x 7+", notes: "Reps limpias, rango completo" },
    { name: "T-bar row", series: "4 x 8-10", load: "42.5 kg" },
    { name: "Remo unilateral con mancuerna", series: "3 x 10-12", load: "34 kg c/u" },
  ...
  "Pull B": [
    ...
    { name: "Curl inclinado con mancuerna", series: "3 x 12 c/u", load: "14 kg c/u" },
  ],
  Pierna: [
    { name: "Goblet squat con mancuerna", series: "4 x 10-12", load: "27.5 kg" },
    { name: "Romanian deadlift con mancuernas", series: "4 x 10-12", load: "30 kg c/u" },
    { name: "Hip thrust con barra", series: "4 x 12-15", load: "72.5 kg" },
    { name: "Curl isquio en maquina", series: "3 x 12-15", notes: "Maquina" },
    ...
    { name: "Aductor en maquina", series: "2 x 15-20", notes: "Maquina" },
  ],
  Carrera: [
