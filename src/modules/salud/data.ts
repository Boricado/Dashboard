...
export const routineTemplates: Record<string, WorkoutExercise[]> = {
  "Push A": [
    { name: "Press de banca plano (barra)", series: "4 x 8-12", load: "57.5 kg" },
    { name: "Press inclinado con mancuernas", series: "3 x 10-12", load: "25 kg c/u" },
    { name: "Press militar con barra", series: "4 x 8-10", load: "35 kg" },
  ...
  "Push B": [
    ...
    { name: "Press de hombro sentado DB", series: "3 x 10-12", load: "17.5 kg c/u" },
    { name: "Elevaciones laterales sentado", series: "4 x 15", load: "10 kg c/u" },
  ...
  "Pull A": [
    ...
    { name: "Remo unilateral con mancuerna", series: "3 x 10-12", load: "35 kg c/u" },
    { name: "Face pulls", series: "4 x 15-20", load: "30 kg" },
    { name: "Curl EZ en banco predicador", series: "3 x 10-12", load: "25 kg" },
    { name: "Curl martillo con mancuernas", series: "3 x 10-12", load: "18 kg c/u" },
    { name: "Dead bug", series: "3 x 10-12 c/u", notes: "Core — lumbares y abdomen" },
    { name: "Pallof press (polea)", series: "3 x 12-15 c/u", load: "15 kg", notes: "Core — rotación" },
  ],
  "Pull B": [
    { name: "Jalon al pecho polea agarre ancho", series: "4 x 10-12", load: "45 kg" },
    { name: "Remo con barra agarre prono", series: "4 x 8-10", load: "45 kg" },
    { name: "Pullover con mancuerna", series: "3 x 12-15", load: "24 kg" },
    { name: "Face pulls", series: "4 x 15-20", load: "30 kg" },
    { name: "Curl EZ barra de pie", series: "3 x 10-12", load: "27.5 kg" },
    { name: "Curl inclinado con mancuerna", series: "3 x 12 c/u", load: "12.5 kg c/u" },
    { name: "Dead bug", series: "3 x 10-12 c/u", notes: "Core — lumbares y abdomen" },
    { name: "Pallof press (polea)", series: "3 x 12-15 c/u", load: "15 kg", notes: "Core — rotación" },
  ],
  Pierna: [
    { name: "Goblet squat con mancuerna", series: "4 x 10-12", load: "25 kg", notes: "Max mancuernas gimnasio" },
    { name: "Romanian deadlift con mancuernas", series: "4 x 10-12", load: "25 kg c/u" },
    { name: "Hip thrust con barra", series: "4 x 12-15", load: "55 lb/lado + barra 20 kg" },
    { name: "Curl isquio en maquina", series: "3 x 12-15", notes: "60 lb" },
    { name: "Elevaciones de talon excentricas (escalon)", series: "4 x 15 c/u", notes: "Corporal" },
    { name: "Abductor en maquina", series: "3 x 15-20", notes: "Maquina" },
    { name: "Aductor en maquina", series: "2 x 15-20", notes: "82 lb" },
  ],
  Carrera: [
